...
# a = c1 * b + c2 * c
@dc.program()
def add3s2(a : dc.float64[nel] @ StorageType.GPU_Global, b : dc.float64[nel] @ StorageType.GPU_Global, c : dc.float64[nel] @ StorageType.GPU_Global, c1 : dc.float64 , c2 : dc.float64):
    #a[:] = c1*b[:] + c2*c[:];
